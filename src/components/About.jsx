export default function About() {
    return (
        <div id="about" className="w-full px-[12%] py-16 scroll-mt-20 bg-gradient-to-b from-white via-purple-50/20 to-orange-50/20 dark:from-darkTheme dark:via-darkTheme dark:to-darkTheme">
            <div className="text-center mb-10">
                <h4 className="mb-2 text-sm font-Ovo text-gray-700 dark:text-gray-300 uppercase tracking-wider">Introduction</h4>
                <h2 className="text-2xl font-Ovo font-bold text-gray-900 dark:text-white">Who Am I?</h2>
                <p className="text-base text-gray-700 dark:text-gray-300 mt-2 italic">The question we all ask ourselves</p>
            </div>

            <div className="flex w-full flex-col lg:flex-row items-start gap-10 max-w-6xl mx-auto">
                {/* Photo sticky */}
                <div className="w-full lg:w-64 flex-shrink-0 mx-auto lg:mx-0 lg:sticky lg:top-24">
                ...
                {/* Contenu */}
                <div className="flex-1 space-y-2.5 text-sm leading-relaxed font-Ovo text-gray-700 dark:text-gray-300">
                    ...
                    <div className="my-4 space-y-2 pl-4 border-l-4 border-[#b820e6]">
                        <p className="text-lg font-semibold text-gray-900 dark:text-white">I am a physicist.</p>
                        <p className="text-lg font-semibold text-gray-900 dark:text-white">I am a philosopher.</p>
                    </div>
