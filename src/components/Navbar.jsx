        ...
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a onClick={() => navigate('/')} className="flex items-center gap-2 cursor-pointer">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#b820e6] to-[#da7d20] flex items-center justify-center text-white font-bold text-xs">
                        BT
                    </div>
                    <span className="text-base font-bold font-Ovo dark:text-white">Bethany Terris</span>
                </a>

                <ul ref={navLinkRef} className="hidden md:flex items-center gap-3 lg:gap-5 rounded-full px-6 py-2 bg-white shadow-sm bg-opacity-50 font-Ovo dark:border dark:border-white/30 dark:bg-transparent text-xs">
