    ...
    return (
        <div id="contact" className="w-full px-[12%] py-20 scroll-mt-20">
            <div className="max-w-4xl mx-auto">
                ...
                <h2 className="text-center text-xs font-Ovo mb-8">Get in Touch</h2>
                ...
                <div className="flex justify-center mb-12">
                    ...
                    <a href="mailto:beth.terris@gmail.com" 
                       className="group p-8 rounded-2xl border-2 border-gray-200 dark:border-white/20 hover:border-[#b820e6] dark:hover:border-[#b820e6] transition-all duration-300 hover:shadow-xl bg-white dark:bg-darkHover/30 max-w-md w-full">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-300 text-center">beth.terris@gmail.com</p>
                    </a>
                </div>

                {/* Location and LinkedIn */}
                <div className="text-center space-y-6 pt-8 border-t border-gray-200 dark:border-white/20">
                    <div className="flex items-center justify-center gap-3 text-xs text-gray-600 dark:text-gray-300">
                    ...
                    <div className="flex items-center justify-center">
                        <a href="https://www.linkedin.com/in/bethanyterris/" 
                           ...
                           className="flex items-center gap-3 px-8 py-4 rounded-full border-2 border-gray-300 dark:border-white/30 hover:border-[#0077b5] dark:hover:border-[#0077b5] hover:bg-[#0077b5] hover:text-white transition-all hover:scale-105 text-xs font-medium">
