    ...
    return (
        <>
            ...
            <div className="w-full px-[12%] py-2">
                <h1 className="text-xxs font-bold font-Ovo mb-8 text-center bg-gradient-to-r from-[#b820e6] via-[#da7d20] to-[#e94560] bg-clip-text text-transparent">
                    Training & Professional Development
                </h1>
                <p className="text-center text-xxs text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    {trainings.map((training, index) => (
                        <div 
                            key={index}
                            className="border-2 border-gray-200 dark:border-white/20 rounded-2xl p-8 hover:border-[#b820e6] dark:hover:border-[#b820e6] transition-all duration-300 hover:shadow-xl bg-white dark:bg-darkHover/30"
                        >
                            <div className="flex items-start gap-6">
                                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[#b820e6] to-[#da7d20] flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-start justify-between mb-6">
                                        <div>
                                            ...
                                            <div className="inline-block px-6 py-2 rounded-full bg-gradient-to-r from-[#b820e6]/10 to-[#da7d20]/10 border border-[#b820e6]/30 dark:border-[#da7d20]/30 mb-6">
                                    ...
                                    <div className="flex flex-wrap gap-8 text-xxs text-gray-600 dark:text-gray-300 mb-8">
                ...
                <div className="max-w-5xl mx-auto mt-20">
                    <h2 className="text-xxs font-bold font-Ovo mb-8 text-center bg-gradient-to-r from-[#b820e6] to-[#da7d20] bg-clip-text text-transparent">
                    ...
                    <div className="space-y-8">
                        {courses.map((course, index) => (
                            <div 
                                key={index}
                                className="border-2 border-gray-200 dark:border-white/20 rounded-2xl p-8 hover:border-[#da7d20] dark:hover:border-[#da7d20] transition-all duration-300 hover:shadow-xl bg-white dark:bg-darkHover/30"
                            >
                                <div className="flex items-start gap-6">
                                    <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[#da7d20] to-[#e94560] flex items-center justify-center flex-shrink-0">
                                        <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-2 text-xxs text-gray-600 dark:text-gray-300 mb-8">
                                            <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
